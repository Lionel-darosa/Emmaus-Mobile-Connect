...
final class Version20230629143336 extends AbstractMigration
{
...
// <<<<<<<< HEAD:migrations/Version20230629172659.php
...
// ========
        $this->addSql('CREATE TABLE device (id INT AUTO_INCREMENT NOT NULL, agency_id INT NOT NULL, brand VARCHAR(100) DEFAULT NULL, model VARCHAR(100) NOT NULL, ram INT NOT NULL, storage INT NOT NULL, state VARCHAR(100) NOT NULL, price DOUBLE PRECISION DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, sold_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', screen_size DOUBLE PRECISION NOT NULL, INDEX IDX_92FB68ECDEADB2A (agency_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
// >>>>>>>> main:migrations/Version20230629143336.php
